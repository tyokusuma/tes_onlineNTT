...
if ($_GET['module']=='home'){
  if ($_SESSION['leveluser']=='admin'){
	...
	echo"<br><div class='row'>
        	<div class='col-sm-4'>
			<p align=center><h3>Welcome To MTs N Kota Kupang</h3></p> 
        ...
        <div class='col-sm-4'>
         <img src='images/logo1.jpg' alt='' width='100%' class='hidden-phone'>
        </div>
      </div>";	
      ...
      <div id='carousel-example-generic' class='carousel slide' data-ride='carousel'>
        ...
        <div class='carousel-inner' role='listbox'>
          <div class='item active'>
            <img src='images/slides/slide11.jpg' alt='First slide'>
          </div>
          <div class='item'>
            <img src='images/slides/slide12.jpg' alt='First slide'>
          </div>
          <div class='item'>
            <img src='images/slides/slide13.jpg' alt='First slide'>
          </div>
        </div>
	...
	echo"<br><div class='row'>
      ...
      <div id='carousel-example-generic' class='carousel slide' data-ride='carousel'>
        ...
        <div class='carousel-inner' role='listbox'>
          <div class='item active'>
            <img src='images/slides/slide15.jpg' alt='First slide'>
          </div>
          <div class='item'>
            <img src='images/slides/slide11.jpg' alt='First slide'>
          </div>
...
echo"  <div class='page-header'></div>
      <div id='carousel-example-generic' class='carousel slide' data-ride='carousel'>
        ...
        <div class='carousel-inner' role='listbox'>
          <div class='item active'>
            <img src='images/slides/slide14.jpg' alt='First slide'>
          </div>
          <div class='item'>
            <img src='images/slides/slide12.jpg' alt='First slide'>
          </div>
